...
def toggle_audio_streaming():
    ...
    if audio_streaming:
        # Stop and close streams if they are running
        ...
        # Select your input and output devices based on the list
        input_device_index = 1  # Microphone USB PnP Audio Device
        output_device_index = 8  #Speakers Realtek(R) Audio 
